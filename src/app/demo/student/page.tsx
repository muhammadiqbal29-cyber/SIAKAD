...
export default function DemoStudentDashboard() {
  const studentName = "Ahmad Maulana";
  const className = "10-A Sains";
      ...
      <div className="bg-amber-500 text-white p-8 rounded-2xl shadow-lg relative overflow-hidden">
        <div className="relative z-10">
          <h1 className="text-3xl font-extrabold mb-2 flex items-center">
            Selamat Datang, {studentName}! <Sparkles className="w-6 h-6 ml-2 text-amber-200" />
          </h1>
          <p className="text-amber-100 font-medium max-w-xl text-lg">
            Kamu saat ini terdaftar di <strong className="text-white bg-amber-600 px-2 py-0.5 rounded-md">Kelas {className}</strong>. Terus semangat belajar dan raih mimpimu!
          </p>
        </div>
