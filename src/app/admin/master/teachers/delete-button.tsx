...
export function DeleteTeacherButton({ id, name }: DeleteButtonProps) {
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[400px] rounded-2xl border-0 shadow-2xl p-0 overflow-hidden">
        <div className="bg-red-50 p-6 border-b border-red-100 flex flex-col items-center text-center">
          ...
          <DialogHeader>
            <DialogTitle className="text-xl font-extrabold text-red-900">Hapus Data Guru?</DialogTitle>
            <DialogDescription className="text-red-700/80 font-medium mt-2">
              Anda yakin ingin menghapus <b>{name}</b> dari sistem? Data yang terkait mungkin tidak dapat dipulihkan.
            </DialogDescription>
          </DialogHeader>
        </div>
