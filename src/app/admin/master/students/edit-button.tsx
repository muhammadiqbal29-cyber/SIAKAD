...
export function EditStudentButton({ student }: EditButtonProps) {
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[450px] rounded-2xl border-0 shadow-2xl p-0 overflow-hidden">
        <div className="bg-gradient-to-r from-blue-50 to-white p-6 border-b border-slate-100">
          <DialogHeader>
            <DialogTitle className="text-2xl font-extrabold text-slate-800">Edit Data Siswa</DialogTitle>
            <DialogDescription className="text-slate-500 font-medium mt-2">
              Perbarui profil dan NISN siswa.
            </DialogDescription>
          </DialogHeader>
        </div>
