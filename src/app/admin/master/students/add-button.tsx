    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[450px] rounded-2xl border-0 shadow-2xl p-0 overflow-hidden">
        <div className="bg-gradient-to-r from-indigo-50 to-white p-6 border-b border-slate-100">
          <DialogHeader>
            <DialogTitle className="text-2xl font-extrabold text-slate-800">Tambah Data Siswa</DialogTitle>
            <DialogDescription className="text-slate-500 font-medium mt-2">
              Masukkan informasi siswa baru. NISN akan menjadi password default untuk login siswa.
            </DialogDescription>
          </DialogHeader>
        </div>
